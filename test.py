...
event_based = embedding.Embedding('event_based', True)
event_based.load_model('/Users/pengxiang/corpora/ontonotes-release-5.0/output/dim300vecs_w_surface_pair_c_lemma_triple', False)
most_sim_event_eval.set_model(event_based)
most_sim_event_eval.evaluate(all_scripts)
