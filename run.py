...
if __name__ == '__main__':
    ...
    eval_most_sim_arg(all_docs, model,
                      use_other_args=False, syntax_suffix=syntax_model, head_only=False, rep_only=False)
    eval_most_sim_arg(all_docs, model,
                      use_other_args=True, syntax_suffix=syntax_model, head_only=False, rep_only=False)

    eval_most_sim_event(all_docs, model,
                        use_max_score=False, syntax_suffix=syntax_model, head_only=False, rep_only=False)
    eval_most_sim_event(all_docs, model,
                        use_max_score=True, syntax_suffix=syntax_model, head_only=False, rep_only=False)

'''
    eval_most_sim_arg(all_docs, model,
                      use_other_args=False, syntax_suffix=syntax_model, head_only=False, rep_only=True)
    eval_most_sim_arg(all_docs, model,
                      use_other_args=True, syntax_suffix=syntax_model, head_only=False, rep_only=True)

    eval_most_sim_event(all_docs, model,
                        use_max_score=False, syntax_suffix=syntax_model, head_only=False, rep_only=True)
    eval_most_sim_event(all_docs, model,
                        use_max_score=True, syntax_suffix=syntax_model, head_only=False, rep_only=True)
'''